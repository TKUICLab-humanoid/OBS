...
#-----------------------------Parameter------------------------------------
def Move(Straight_status = 0 ,x = -300 ,y = 0 ,z = 0 ,theta = 1  ,sensor = 0 ):
    ...
    if Straight_status == 0:            #stay
        ...
        if red_flag == True:
            ...
            if Yaw_wen <= 0: #8修左
                ...
                send.sendContinuousValue(x,y +800 ,z,theta + imu_angle,sensor)
...
#============================================================================#       
        ...
        send.sendContinuousValue(3000 ,-200 ,z ,-1 ,sensor)
        ...
        Slope_fix()
        send.sendContinuousValue(-1300 ,-200 ,z ,-1 + slope_angle ,sensor)
...
#------------------reddoor slope parameter------------------------#
        ...
        if send.color_mask_subject_size[5][0] ==0 :           #黃線出障礙物的平移
            rx = 0
        send.sendContinuousValue(-400 + rx , 600 ,0 ,0 + slope_angle ,0) 
    ...
    try:
        ...
        while not rospy.is_shutdown():
            if send.is_start == True:
                ...
                YYDS = 1   #Y_Line_Deep 2  4
                CRMax = 45 #R_Max       45 30
                CRMin = 35 #R_MIn       35 20
