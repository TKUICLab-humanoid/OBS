...
#-----------------------------Parameter------------------------------------
def Move(Straight_status = 0 ,x = 300 ,y = 300 ,z = 0 ,theta = -1  ,sensor = 0 ):
...
#============================================================================#       
        ...
        send.sendContinuousValue(2000 ,300 ,z , -1,sensor)
        ...
        Slope_fix()
        send.sendContinuousValue(-500 ,300 ,z ,0 + slope_angle ,sensor)
