        ...
        switch(strategy_state)
        {
            ...
            case REDDOOR:
                ...
                else if(RD == LD)       //對下方藍模做比較
                {
                    ...
                    else if(/*R_XMIN*/ RightblueOBS_XMin < 240)
                    {
                        ROS_INFO("LEFT_MOVE");
                    ...
                    else if(/*L_XMAX < 50 || R_XMIN < 50 ||*/ LeftblueOBS_XMax < 70 || RightblueOBS_XMin > 240 || LeftblueOBS_XMax < 70 && RightblueOBS_XMin > 240)
                    {
