...
class Walk(): #步態、轉彎、直走速度、IMU
    ...
    def move(self, action_id, z=0, sensor= 0):
        ...
        actions             = { 'stay'                  : {'x':  0,                 'y':  300,               'theta': 0 },
                                ...
                                'slope_fix'             : {'x': -100 if deep.slope > 0 else -200,                   'y':    -300 if deep.slope > 0 else 800,           'theta': self.slope()},
